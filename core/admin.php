<?php 
    ...
    include_once dirname(__FILE__) . '/classes/resource.php';
	$thisPage = 'admin';
    $message = '';
    $messageType='success';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script type="text/javascript" src="<?php echo Config::$site_root?>/js/admin.js"></script>
    </head>
    <body>
    	<div id="maincontent">
    		<div id="outer">
	        	...
	        	<div class="container">
		        	...
		        	<div class="tab-content">
			        	...
			        	<div id="import" role="tabpanel" class="tab-pane">
				        	...
				        	<form id="uploadForm" action="core/service/upload.php" method="post" enctype="multipart/form-data" role="form">
				        		<div class="form-group">
