			  ...
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        ...
			        <h4 id="configHeader" class="modal-title">Search Options</h4>
			      </div>
			      <div id="configBody" class="modal-body">
			         <form id="settingsForm">
			      		<div class="panel panel-default">
					      	<div class="panel-heading">Filter locations to show only the following categories:</div>
				        ...
				        <div class="form-group <?php if (!$showNumLocations) { echo 'hidden';}?>">
