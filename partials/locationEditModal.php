			<div id="locationEditModal" class="modal fade" role="dialog">
			  <div class="modal-dialog modal-lg">
			    <!-- Modal content-->
			    <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal">&times;</button>
			        <h4 id="locationEditHeader" class="modal-title">Modal Header</h4>
			      </div>
			      <div id="locationEditBody" class="modal-body">
			      	<div id="locationEditLoading" class="ajaxLoading">
			      	</div>
			      	<div id="locationEditContainer" class="container-fluid">
			      ...
			      <div class="modal-footer">
					...
					<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Cancel</button>
			      	<button id="locationEditSaveButton" type="button" class="btn btn-primary" onclick="saveLocation();" disabled>
